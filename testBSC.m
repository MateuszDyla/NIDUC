...
%
Test(j+10*(i-1),1:9) = [1,1,err,ber,berPercent,incorrectLetters,percentIncorrectLetters,redundancy1,redundancy];
j=j+1;
end
i=i+1;
end
...
redundancy = 100*(height(codedVectors)*width(codedVectors))/(height(decodedVectors)*width(decodedVectors));
%
Test(1000+j+10*(i-1),1:9) = [2,1,err,ber,berPercent,incorrectLetters,percentIncorrectLetters,redundancy1,redundancy];
j=j+1;
end
i=i+1;
end
...
redundancy = 100*(height(codedVectors)*width(codedVectors))/(height(decodedVectors)*width(decodedVectors));
%
Test(2000+j+10*(i-1),1:9) = [3,1,err,ber,berPercent,incorrectLetters,percentIncorrectLetters,redundancy1,redundancy];
j=j+1;
end
i=i+1;
end
...
redundancy = 100*(height(codedVectors)*width(codedVectors))/(height(decodedVectors)*width(decodedVectors));
%
Test(3000+j+10*(i-1),1:9) = [4,1,err,ber,berPercent,incorrectLetters,percentIncorrectLetters,redundancy1,redundancy];
j=j+1;
end
i=i+1;
end
...
redundancy = 100*(height(codedVectors)*width(codedVectors))/(height(decodedVectors)*width(decodedVectors));
%
Test(4000+j+10*(i-1),1:9) = [5,1,err,ber,berPercent,incorrectLetters,percentIncorrectLetters,redundancy1,redundancy];
j=j+1;
end
i=i+1;
end
...
redundancy = 100*(height(codedVectors)*width(codedVectors))/(height(decodedVectors)*width(decodedVectors));
%
Test(5000+j+10*(i-1),1:9) = [6,1,err,ber,berPercent,incorrectLetters,percentIncorrectLetters,redundancy1,redundancy];
j=j+1;
end
i=i+1;
end
...
redundancy = 100*(height(codedVectors)*width(codedVectors))/(height(decodedVectors)*width(decodedVectors));
%
Test(6000+j+10*(i-1),1:9) = [7,1,err,ber,berPercent,incorrectLetters,percentIncorrectLetters,redundancy1,redundancy];
j=j+1;
end
i=i+1;
end
...
redundancy = 100*(height(codedVectors)*width(codedVectors))/(height(decodedVectors)*width(decodedVectors));
%
Test(7000+j+10*(i-1),1:9) = [8,1,err,ber,berPercent,incorrectLetters,percentIncorrectLetters,redundancy1,redundancy];
j=j+1;
end
i=i+1;
end
